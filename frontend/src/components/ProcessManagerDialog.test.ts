...
describe('ProcessManagerDialog', () => {
  it('uses shared glass tokens for the dialog shell and process surfaces', () => {
    expect(processDialogSource).toContain('background: var(--material-backdrop-bg)')
    expect(processDialogSource).toContain('background: var(--material-surface-bg)')
    expect(processDialogSource).toContain('border: 1px solid var(--material-border')
    expect(processDialogSource).toContain('box-shadow: var(--material-shadow)')
    expect(processDialogSource).toContain('backdrop-filter: var(--material-blur)')
    expect(processDialogSource).toContain('-webkit-backdrop-filter: var(--material-blur)')
    expect(processDialogSource).toContain('background: var(--material-toolbar-bg)')
    expect(processDialogSource).toContain('background: var(--material-panel-bg)')
    expect(processDialogSource).toContain('background: var(--material-card-bg)')
