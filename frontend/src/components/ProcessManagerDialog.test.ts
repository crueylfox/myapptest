...
describe('ProcessManagerDialog', () => {
  it('uses shared glass tokens for the dialog shell and process surfaces', () => {
    expect(processDialogSource).toContain('background: var(--surface-backdrop-bg)')
    expect(processDialogSource).toContain('background: var(--surface-modal-bg)')
    expect(processDialogSource).toContain('border: 1px solid var(--surface-border')
    expect(processDialogSource).toContain('box-shadow: var(--surface-shadow)')
    expect(processDialogSource).toContain('backdrop-filter: var(--surface-blur)')
    expect(processDialogSource).toContain('-webkit-backdrop-filter: var(--surface-blur)')
    expect(processDialogSource).toContain('background: var(--surface-toolbar-bg)')
    expect(processDialogSource).toContain('background: var(--surface-panel-bg)')
    expect(processDialogSource).toContain('background: var(--surface-card-bg)')
