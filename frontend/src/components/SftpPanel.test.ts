...
describe('SftpPanel', () => {
  ...
  it('hides the remote path toolbar until SFTP is online', () => {
    ...
    expect(unbound.get('.sftp-panel').classes()).toContain('sftp-empty-state')
    expect(unbound.get('.sftp-panel').classes()).not.toContain('empty-state')
    ...
    expect(failed.get('.sftp-panel').classes()).toContain('sftp-empty-state')
    expect(failed.get('.sftp-panel').classes()).not.toContain('empty-state')
